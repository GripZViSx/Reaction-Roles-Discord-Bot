  ...
  if (
    ...
    let row = new Discord.MessageActionRow().addComponents(
      new Discord.MessageButton()
        .setLabel("Invite Me")
        .setURL(
          "https://discord.com/api/oauth2/authorize?client_id=1014190483720908910&permissions=8&scope=bot%20applications.commands"
        )
        .setStyle("LINK"),

      new Discord.MessageButton()
        .setLabel("Support Server")
        .setURL("https://dsc.gg/stacx-dev")
        .setStyle("LINK")
    );
    ...
    client
      .embed(
        {
          title: "Task N",
          desc: `A Reaction Role Bot`,
          fields: [ 
            {
              name: "How To Use ❓",
              value: `1. Startup with using \`/reactionroles help\`\n2. Then Do \`/reactionroles add\` And In "Category" Add The Name Of Your Reaction Role . __eg. Colour Roles__\n(Repeat the same with same category name to add more then one role .) And Fill "Role" And "Emoji" Accordingly\n3. When Done, Do \`/reactionroles button\` For Button Menu & Do \`/reactionroles menu\` For Menu Role.`,
            },
          ],
          components: [row],
        },
